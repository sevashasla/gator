...
from gator.relpose.datasets.utils.transforms import ImgNorm
import gator.relpose.datasets.utils.cropping as cropping
from gator.relpose.datasets.base.easy_dataset import EasyDataset
...
class BaseStereoViewDataset (EasyDataset):
    ...
    def __init__(self, *,  # only keyword arguments
        ...
        logger.log("Building BaseStereoViewDataset with the following options:")
        self.num_views = 2
        self.split = split
